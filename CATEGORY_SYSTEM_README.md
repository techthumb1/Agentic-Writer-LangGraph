...
- **50 Professional Style Profiles** across 5 categories
- **3 Content Templates** with style alignment
...
```text
data/
├── style_profiles/           # 50 professional style profiles
│   ├── phd_dissertation.yaml
│   ├── api_documentation.yaml
│   ├── executive_summary.yaml
│   └── ...
├── content_templates/        # 3 content templates
...
#### 10 Professional Styles (Academic & Research)

Scholarly writing for academic institutions, research papers, and peer-reviewed publications

*Example Styles*: PhD Dissertation, Peer Review Article, Literature Review...

### ⚙️ Technical Documentation

#### 10 Professional Styles (Technical Documentation)

Precise technical writing for developers, engineers, and technical professionals

*Example Styles*: API Documentation, System Architecture, Implementation Guide...

### 📊 Business Strategy

#### 10 Professional Styles (Business Strategy)

Strategic business communication for executives, stakeholders, and decision-makers
...
Instructional content for learning, training, and knowledge transfer
