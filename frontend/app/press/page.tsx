...
export const metadata: Metadata = {
  title: 'Press Kit | AI Content Studio',
  description: 'Media resources and press information for AI Content Studio.',
};
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300">
            Media resources and press information for AI Content Studio.
          </p>
        </div>
