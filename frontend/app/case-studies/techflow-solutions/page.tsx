...
export default function TechFlowCaseStudyPage() {
  ...
  const results = [
    {
      metric: "300% Increase in Content Volume",
      description: "From 12 to 36 high-quality articles per month, enabling TechFlow to dominate their content marketing space."
    },
    {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-300 mb-4">
                  TechFlow Solutions was experiencing rapid growth but struggling to keep up with content demands. 
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-br from-purple-600/10 to-pink-600/10 rounded-xl p-8 border border-purple-400/20 text-center">
            ...
            <cite className="text-gray-400">
              ...
              <div>Content Marketing Manager, TechFlow Solutions</div>
            </cite>
          </div>
        </section>
